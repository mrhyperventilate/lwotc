...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(PurePassive('DoubleRendFocus', "img:///UILibrary_PerkIcons.UIPerk_advent_commandaura"));
	Templates.AddItem(TemplarShield());
	Templates.AddItem(SoulShot());
	Templates.AddItem(Rend_LW());
...
static function X2AbilityTemplate Rend_LW()
{
	local X2AbilityTemplate Template;
	local X2Effect_ModifyTemplarFocus FocusEffect;

	Template = class'XComGame.X2Ability_TemplarAbilitySet'.static.Rend('Rend_LW');
