...
static function X2AbilityTemplate AddHailstorm()
{
	...
	// Icon Properties
	Template.IconImage = "img:///UILibrary_LWOTC.UI.UIPerk_hailstorm";
...
static function X2AbilityTemplate AddThrowingKnifeFaceoff()
{
	...
	Template.IconImage = "img:///UILibrary_LWOTC.UI.UIPerk_faceoff";
...
static function X2AbilityTemplate AddKnifeJuggler()
{
	...
	Template.IconImage = "img:///UILibrary_LWOTC.UIPerk_throwknife";
...
static function X2AbilityTemplate ImpersonalEdgePassive()
{
	...
	Template = PurePassive('ImpersonalEdgePassive', "img:///UILibrary_LWOTC.UI.UIPerk_hailstorm", , 'eAbilitySource_Perk');
