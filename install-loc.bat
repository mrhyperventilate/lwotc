...
"C:\Program Files\PowerShell\7\pwsh.exe" -NonInteractive -ExecutionPolicy Unrestricted  -file "%~dp0.scripts\install_loc.ps1" -srcDirectory "%~dp0\" -sdkPath "%XCOM2SDKPATH%" -gamePath "%XCOM2GAMEPATH%"
